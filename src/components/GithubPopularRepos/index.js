...
class GithubPopularRepos extends Component {
  ...
  getPopularReposList = async () => {
    ...
    try {
      ...
      this.setState({ popularReposList: modifiedData, apiStatus: apiStatuses.success })
    } catch (error) {
  ...
  renderFailureView = () => (
    <>
      <img src="https://assets.ccbp.in/frontend/react-js/api-failure-view.png" alt="failure view" className="failure-view" />
